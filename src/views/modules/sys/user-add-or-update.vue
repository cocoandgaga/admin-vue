<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="院系专业" prop="deptId">
        <!-- <el-input v-model="dataForm.deptId" placeholder="院系专业"></el-input> -->
        <div class="block">
          <el-cascader
  ...
  methods: {
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.categoryIds=data.user.categoryIds;
              }
            });
          }
        });
    ...
    dataFormSubmit() {
      this.$refs["dataForm"].validate((valid) => {
        if (valid) {
          console.log("userId:",this.dataForm.id)
          this.$http({
